			...
			<div class="btn-group">
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered table-hover table-condensed">
						...
						<tr>
							...
							<th width="135px" align="center">
								<a href="tarifs/create" type="button" class="btn btn-block btn-default btn-xs">
					...
					<span style="float: left;">
						{{ '(Hasil '. $tarifs->getFrom() .'-'. $tarifs->getTo() .' )  <b>jumlah data :</b> '. $tarifs->getTotal()}}
					</span>
			</div>
